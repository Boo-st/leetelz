...
class woodstocks():
	...
	def new_count(file=r'\Users\Mitchel.M.King\Documents\test.txt'):
		while True:
			...
			if exists == 'y':
				with open(file, 'r') as item:
					try:
						...
						Horses, Elephants, Dogs, Seals = woodstocks.update_count()
						return False
		...
		with open('\Users\Mitchel.M.King\Documents\test.txt', 'w') as new_f:
			new_f.write('Horses ' + Horses + horses_d + '\n' + 'Elephants ' + Elephants + elephants_d + '\n' + 'Dogs ' + Dogs + dog_d + '\n' + 'Seals ' + Seals + seal_d)			
			else:
				return False	
